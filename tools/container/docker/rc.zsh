...
export docker_rc="~/dev/ops/dot-zsh/docker.zsh"
alias dkvi="vi $docker_rc && source $docker_rc"
# DONOT use -a or --all to delete local loaded tag images!!!
alias dkimgprune="docker image prune --force"
