...
{
  # 1. 明确告诉 nix-darwin，闭上它管底层引擎的嘴，完全交由nix-installer管理
  nix.enable = false;
  ...
  #   sudo /bin/launchctl kickstart -k system/org.nixos.nix-daemon 2>/dev/null || {
  #     echo ""
  ...
  #     echo "   👉 sudo launchctl bootstrap system /Library/LaunchDaemons/org.nixos.nix-daemon.plist"
  #     echo "----------------------------------------------------------------------"
  #     echo ""
  #   } || true
